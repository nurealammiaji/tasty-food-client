...
const Footer = () => {
    return (
        <div>
            <br /><br />
            <footer className="bg-neutral text-neutral-content grid md:grid-cols-2">
                <div className="col-span-1 bg-slate-700 text-center p-10">
                    <img className="h-[70px] mx-auto" src={logo} alt="Tasty Food Logo" />
                    <br />
                    <p className="text-xl">Tasty Food Restaurant</p>
                    <p>Providing delicious foods since 2010</p>
                </div>
                <div className="col-span-1 text-center p-10">
                    <div>
                        <h2 className="footer-title">Office Address</h2>
                        <p className="mt-3 mb-1 text-lg font-medium">Tasty Food Restaurant</p>
            ...
            <footer className="px-10 py-4 text-neutral-content footer bg-black">
                ...
                <aside className="md:place-self-center md:justify-self-end">
                    <p>Copyright © 2023, All right reserved by Tasty Food Restaurant</p>
                </aside>
            </footer>
        </div>
    );

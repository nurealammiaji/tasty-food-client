...
const Footer = () => {
    return (
        <div>
            <br /><br />
            <footer className="grid bg-neutral text-neutral-content md:grid-cols-2">
                <div className="col-span-1 p-10 text-center bg-slate-700">
            ...
            <footer className="px-10 py-4 bg-black text-neutral-content footer">
